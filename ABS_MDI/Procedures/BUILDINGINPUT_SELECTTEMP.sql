CREATE OR REPLACE PROCEDURE abs_mdi."BUILDINGINPUT_SELECTTEMP" 
(
  ProjectId                             IN   NUMBER,
...
BEGIN
    OPEN OUTPUT_INFORMATION FOR SELECT
                                    ...
                                    P."ProjectName"
                                FROM
                                    "BuildingInformation" BI ,"Project"P
                                WHERE
                                        BI."BuildingInformationId" = BuildingInformationId And P."ProjectId"=ProjectId
                                    AND BI."IsDelete" != 'Y';
    SELECT
        COUNT(*)
    INTO L_COUNT
    ...
    OPEN OUTPUT_INSULATION FOR SELECT
                                  ...
                                  NVL("BuildingHasInsulation", 0)       "BuildingHasInsulation",
   ...
   OPEN OUTPUT_ADDLINES FOR SELECT
                            ...
                            WHERE
                                   AddLines."BuildingInformationId" = BuildingInformationId and AddLines."ScreenType"='ShopCoat'
                               AND Info."ProjectId" = ProjectId;
