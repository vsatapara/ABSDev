CREATE OR REPLACE PROCEDURE abs_mdi."ACCESSORIES_FACADE_COMMON" 
...
(
    ...
    Output_Wall_Data OUT SYS_REFCURSOR
)
AS
...
BEGIN
    ...
    OPEN Output_Wall_Data FOR
        SELECT PanelType."Type",PanelType."Id" 
        FROM "Input_Wall" Wall JOIN "M_PanelType" PanelType ON Wall."Type" = PanelType."Id" 
        WHERE Wall."BuildingInformationId" = BuildingId;
END ACCESSORIES_FACADE_COMMON;
/