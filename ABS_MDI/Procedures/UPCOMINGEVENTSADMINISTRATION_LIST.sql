CREATE OR REPLACE PROCEDURE abs_mdi."UPCOMINGEVENTSADMINISTRATION_LIST" 
(
    CompanyId IN NUMBER,
...
OPEN Output_Data FOR
	...
	WHERE U."IsActive" = 'Y' and U."CompanyId" = CompanyId and (U."IsDelete" is null or U."IsDelete"='N');
END UPCOMINGEVENTSADMINISTRATION_LIST;
/