CREATE OR REPLACE PROCEDURE abs_mdi."QUOTE_MANAGEMENT_COPY" (
    ProjectId IN NUMBER,
...
BEGIN
  ...
  LOOP
  DECLARE x_1 number; x_2 number;
  BEGIN
        SELECT r_product."ProjectId", r_product."BuildingInformationId"  INTO x_1, x_2 FROM dual;
    ...
    VALUES((SELECT "BuildingLabel" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "Structure" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "BuildingName" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "BuildingType" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "Elevation" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "FrameType" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		OutputId,
		UserDetailId,
		CURRENT_TIMESTAMP,
		(SELECT "IpAddress" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "IsDelete" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "AttachmentElevation" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "HighSideWallElevation" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "ParentBuildingId" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "BuildingHasInsulation" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "InsulationByBrand" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "ComCheck" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "IsComplete" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2),
		(SELECT "UseSeismicDesignCategory" FROM "BuildingInformation" WHERE "ProjectId" = x_1 AND "BuildingInformationId" = x_2)) returning "BuildingInformationId" into NewBuildingInformationId;
    ...
    WHERE gi."BuildingInformationId" = x_2;
...
BEGIN
  ...
  BEGIN
    ...
    VALUES( 
		NewBuildingInformationId,
		(SELECT igbs."SW1Style" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."SW2Style" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."EW1Style" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."EW2Style" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."RoofPurlinStyle" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."SW1Depth" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."SW2Depth" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."EW1Depth" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."EW2Depth" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."RoofPurlinDepth" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."SW1Optimize" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."SW2Optimize" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."EW1Optimize" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."EW2Optimize" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."RoofPurlinOptimize" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."RoofBaySpacing" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."WallBaySpacing" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."GirtSpacing" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."PurlinSpacing" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."LBPMinDepth" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."LBPMaxDepth" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		UserDetailId,
		CURRENT_TIMESTAMP,
		(SELECT igbs."IsDelete" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."IpAddress" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."FrameBoltWashers" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."GrayPrimer" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."OptimizeGirt1" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."OptimizeGirt2" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."OptimizePurlin" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."GirtWidth1" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."GirtWidth2" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."PurlinWidth" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."PortalRafterDepth1" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."PortalRafterDepth2" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."PortalColumnDepth1" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."PortalColumnDepth2" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6),
		(SELECT igbs."LBPBracingLoc" FROM "Input_GirtsBaySpacing" igbs WHERE "GirtSpacingId" = y_6)) returning "GirtSpacingId" into NewGirtSpacingId;
...
END;
    ...
    WHERE isc."BuildingInformationId" = x_2;
    ...
    VALUES( 
        NewBuildingInformationId,
		(SELECT ia."Description" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."UnitWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."UnitPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."ListOrNet" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."ExpiresOn" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."QuoteNumber" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."QuoteYear" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."EstInitials" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."Guid" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."Quantity" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."Internal" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."IncludeFreight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."DontShowPriceWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."IsSpecialized" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."ScreenType" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."TaxApplied" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."AdjustmentFactor" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."Expired" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."Category" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."BuiltupWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."BuiltupPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."HotrolledWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."HotrolledPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."ColdformWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."ColdformPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."FabColdformWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."FabColdformPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."RoofpanelWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."RoofpanelPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."WallpanelWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."WallpanelPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."TrimWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."TrimPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."BuyoutsWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."BuyoutsPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."WarehouseWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."WarehousePrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."OtherWeight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."OtherPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."AdditionalEngineering" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."DrawingsCalcs" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."WTWarranty" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia.insulation FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."Freight" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."FabricatedICF" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."BuyoutMarkup" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."DetailsByPercentage" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."MezzanineNumber" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."RmgPrice" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."ProjectId" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."IpAddress" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		(SELECT ia."IsDelete" FROM "Input_AddLines" ia WHERE "BuildingInformationId" = x_2),
		UserDetailId,
    ...
    WHERE inad."Guid" IN (SELECT "Guid" FROM "Input_AddLines" WHERE "BuildingInformationId" = x_2);
	...
	VALUES(NewBuildingInformationId,
		(SELECT ie."FrameType" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		UserDetailId,
		CURRENT_TIMESTAMP,
		(SELECT ie."IpAddress" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		OutputId,
		(SELECT ie."EndWallNo" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		(SELECT ie."ElevationType" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		(SELECT ie."IsDeleted" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		(SELECT ie."ColumnSpacingType" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		(SELECT ie."InsulationTrim" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		(SELECT ie."NonStandardSetback" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		(SELECT ie."DesignedSetback" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		(SELECT ie."SpecifiedSetback" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		(SELECT ie."BayCount" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3),
		(SELECT ie."GableFlash" FROM "Input_Endwall" ie WHERE "EndWallID" = y_3)) returning "EndWallID" INTO NewEndWallID;
    ...
    WHERE iecs."EndWallID" = y_3 AND "BuildingNo" = x_2;        
    ...
    WHERE ier."EndWallID" = y_3 AND "BuildingNo" = x_2;
END;
  END LOOP;
END;
	...
	VALUES( 
		NewBuildingInformationId,
		(SELECT br."SW1BracingType" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW1Tiers" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW1BracingLocations" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW1UnbraceableLocations" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW1ExcludeDiaphragm" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW2BracingType" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW2Tiers" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW2BracingLocations" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW2UnbraceableLocations" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW2ExcludeDiaphragm" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW3BracingType" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW3Tiers" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW3BracingLocations" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW3UnbraceableLocations" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW3ExcludeDiaphragm" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW4BracingType" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW4Tiers" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW4BracingLocations" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW4UnbraceableLocations" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW4ExcludeDiaphragm" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."RoofBracingType" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."RoofBracingLocations" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."RoofUnbraceableLocations" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."RoofExcludeDiaphragm" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."Purlins" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."Girts" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."ErectionRods" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."AllowTorsion" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."ErectionBayWidth" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."RafterFlangeBrace" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."ColumnFlangeBrace" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW1PFrameType" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW1PFrameHeight" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW2PFrameType" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW2PFrameHeight" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW1FBBCRight" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW2FBBCRight" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW1Girts" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."SW2Girts" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW3Girts" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW4Girts" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW3PFrameType" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW3PFrameHeight" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW4PFrameType" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."EW4PFrameHeight" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."OverrideFlangeBraceRoof" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."OverrideFlangeBraceWall" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		UserDetailId,
		CURRENT_TIMESTAMP,
		(SELECT br."IsDelete" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."IpAddress" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		NewBuildingInformationId,
		(SELECT br."LBPBracingLocation" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."IsReset" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."PortalRafterDepth1" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."PortalRafterDepth2" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."PortalRafterDepth3" FROM "Bracing" br WHERE br."BuildingNumber" = x_2),
		(SELECT br."PortalRafterDepth4" FROM "Bracing" br WHERE br."BuildingNumber" = x_2)) returning "BracingId" into NewBracingId;
	...
	SELECT
		...
		iw."FoamTape"
	FROM "Input_Wall" iw
    WHERE iw."BuildingInformationId" = x_2;
    ...
    WHERE arl."BuildingNumber" = x_2 AND arl."ProjectId" = x_1;
    ...
    WHERE arpf."BuildingId" = x_2 AND arpf."ProjectId" = x_1;
    ...
    WHERE av."BuildingId" = x_2 AND av."ProjectId" = x_1;
    ...
    WHERE awl."BuildingInformationId" = x_2 AND awl."ProjectId" = x_1;
    ...
    WHERE aw."BuildingNumber" = x_2 AND aw."ProjectId" = x_1;
    ...
    WHERE awd."BuildingId" = x_2 AND awd."ProjectId" = x_1;
    ...
    WHERE atmsd."BuildingNumber" = x_2 AND atmsd."ProjectId" = x_1;
    ...
    WHERE adbd."BuildingId" = x_2 AND adbd."ProjectId" = x_1;
    ...
    WHERE al."BuildingId" = x_2 AND al."ProjectId" = x_1;
    ...
    WHERE afo."BuildingNumber" = x_2 AND afo."ProjectId" = x_1;
    ...
    WHERE alr."BuildingNumber" = x_2 AND alr."ProjectId" = x_1;
    ...
    WHERE ac."BuildingNumber" = x_2 AND ac."ProjectId" = x_1;
    ...
    WHERE afc."BuildingInformationId" = x_2 AND afc."ProjectId" = x_1;
    ...
    WHERE apt."BuildingInformationId" = x_2 AND apt."ProjectId" = x_1;
    ...
    WHERE avgt."BuildingInformationId" = x_2 AND avgt."ProjectId" = x_1;
    ...
    WHERE awn."BuildingInformationId" = x_2 AND awn."ProjectId" = x_1;
    ...
    WHERE acr."BuildingId" = x_2 AND acr."ProjectId" = x_1;
    ...
    WHERE eiom."BuildingNumber" = x_2 AND eiom."ProjectId" = x_1;
    ...
    WHERE eioms."BuildingNumber" = x_2 AND eioms."ProjectId" = x_1;
    ...
    WHERE eiomo."BuildingNumber" = x_2 AND eiomo."ProjectId" = x_1;
    ...
    VALUES(
		NewBuildingInformationId,
		(SELECT apn."Type" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."Length" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."Height" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."DistFromEndWall" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."DistFromSideWall" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."FullHeight" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."PanelType" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."Width" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."Thickness" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ReverseRoll" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ExteriorProfile" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ExteriorGuage" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ExteriorTexture" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ExteriorColor" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ExteriorColorSpecialName" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ExteriorColorValsparCode" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."InteriorProfile" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."InteriorGuage" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."InteriorTexture" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."InteriorColor" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."InteriorColorSpecialName" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."InteriorColorValsparCode" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."FactoryAppliedSealant" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."SheeterSide" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ExteriorWall" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."RecessFoundation" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."BaseClosureStrips" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."PurlinTrimColor" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."PurlinTrimColorSpecialName" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."PurlinTrimColorValsparCode" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."CornerTrimColor" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."CornerTrimColorSpecialName" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."CornerTrimColorValsparCode" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."FramingByOthers" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."BaseCondition" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."FastenerHeadFinish" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."FastenerLength" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."GirtSpacing" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."IsDelete" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		UserDetailId,
		CURRENT_TIMESTAMP,
		(SELECT apn."IpAddress" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		OutputId,
		(SELECT apn."GirtDepth" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."GirtType" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."StructuralPrice" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."Elevation" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."BaseHeight" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."DistFromWall" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."PanelFinish" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."Weight" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."Price" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."IsPriced" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ErrorCode" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."PriceInsulation" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."InsulationFacing" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."IMPLoads" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."IMPPlant" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."PanelColor" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."SheetBothSides" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ByEstimating" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."QuoteNumber" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."QuoteYear" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."EstimatorInitials" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ExpiresOn" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."Expired" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."StartLoc" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."StopLoc" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."EstPrice" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."EstWeight" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."ShowComplete" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."WeightMBCI" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."PriceMBCI" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."StructuralWeight" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5),
		(SELECT apn."SquareFeet" FROM "Accesories_Partition" apn WHERE apn."PartitionId" = y_5)) returning "PartitionId" INTO NewPartitionId;
