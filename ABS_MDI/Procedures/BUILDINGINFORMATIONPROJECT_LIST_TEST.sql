CREATE OR REPLACE PROCEDURE abs_mdi."BUILDINGINFORMATIONPROJECT_LIST_TEST" (
       UserId        IN   VARCHAR2,
    CompanyId     IN   NUMBER,
...
BEGIN
    ...
    WHERE
            "UserId" = UserId
        AND "IsDelete" = 'N';
          execute immediate 'truncate table "Customer_Temporary" drop storage';
LOCK TABLE 'Customer_Temporary' NO WAIT
                        ...
                        BEGIN
                            OPEN Output_Data FOR SELECT DISTINCT
                                                 ...
                                                 FROM
                                                     ...
                                                     LEFT JOIN "Customer_Temporary" ct ON ct."CustomerNo" = pt."CustomerNo"
                                                 WHERE
                                        ...
                                        FROM
                                            (
                                                ...
                                                WHERE
                                                        pt."IsDelete" = 'N'
                                                    AND pt."CompanyId" = CompanyId
                                                    AND ( pt."CustomerNo" = ct."CustomerNo"
...
END BUILDINGINFORMATIONPROJECT_LIST_Test;
/