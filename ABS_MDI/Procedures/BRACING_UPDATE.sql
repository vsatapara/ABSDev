CREATE OR REPLACE PROCEDURE abs_mdi."BRACING_UPDATE" 
(
    BracingId IN NUMBER,
...
BEGIN
 BracingIdCheck := 0;
   select count(*)  INTO  IsExist from "Bracing" where "BracingId" = BracingId;
    ...
    IF IsExist > 0 THEN
      UPDATE "Bracing" SET
        ...
        "SW1Girts"=NVL(SW1Girts,'None'),
        "SW2Girts"=NVL(SW2Girts,'None'),
        "EW3Girts"=NVL(EW3Girts,'None'),
        "EW4Girts"=NVL(EW4Girts,'None'),
      ...
      IF IsExist > 0 THEN
      UPDATE "SideWallPortalFrame" SET
            "SW1Height" = SW1Height,
    ...
    ELSE
        ...
        RETURNING "BracingId" into OutputId;
        --select BracingId  INTO  BracingIdCheck from "Bracing" where "BuildingInformationId" = BuildingInformationId;
        If OutputId > 0 THEN
