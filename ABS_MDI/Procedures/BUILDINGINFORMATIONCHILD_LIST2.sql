...
BEGIN
    ...
    OPEN Output_Data FOR SELECT
                             ...
                             (select "BuildingInformationId" AS "BuildingId" from "Input_GirtsBaySpacing" WHERE "BuildingInformationId"= info."BuildingInformationId")
                         FROM
                             ...
                             LEFT JOIN "Project" P ON P."ProjectId" = info."ProjectId"
                         WHERE
